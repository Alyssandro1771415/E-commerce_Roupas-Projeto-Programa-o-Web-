...
--
-- Host: localhost    Database: ecommerce_roupas
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  `order_status` ENUM('PENDING','PAID','SHIPPED','DELIVERED','CANCELED') DEFAULT 'PENDING',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-05-14 11:06:00
